...
public class PayActivity1 extends Activity {
	...
	private class GetAccessTokenTask extends AsyncTask<Void, Void, GetAccessTokenResult> {
		...
		protected void onPreExecute() {
			dialog = ProgressDialog.show(PayActivity1.this, getString(R.string.app_tip), getString(R.string.getting_access_token));
		}
		...
		protected void onPostExecute(GetAccessTokenResult result) {
			...
			if (result.localRetCode == LocalRetCode.ERR_OK) {
				Toast.makeText(PayActivity1.this, R.string.get_access_token_succ, Toast.LENGTH_LONG).show();
				Log.d(TAG, "onPostExecute, accessToken = " + result.accessToken);
				
				GetPrepayIdTask getPrepayId = new GetPrepayIdTask(result.accessToken);
				getPrepayId.execute();
			} else {
				Toast.makeText(PayActivity1.this, getString(R.string.get_access_token_fail, result.localRetCode.name()), Toast.LENGTH_LONG).show();
			}
		}
	...
	private class GetPrepayIdTask extends AsyncTask<Void, Void, GetPrepayIdResult> {
		...
		@Override
		protected void onPreExecute() {
			dialog = ProgressDialog.show(PayActivity1.this, getString(R.string.app_tip), getString(R.string.getting_prepayid));
		}
		...
		protected void onPostExecute(GetPrepayIdResult result) {
			...
			if (result.localRetCode == LocalRetCode.ERR_OK) {
				Toast.makeText(PayActivity1.this, R.string.get_prepayid_succ, Toast.LENGTH_LONG).show();
				sendPayReq(result);
			} else {
				Toast.makeText(PayActivity1.this, getString(R.string.get_prepayid_fail, result.localRetCode.name()), Toast.LENGTH_LONG).show();
			}
		}
